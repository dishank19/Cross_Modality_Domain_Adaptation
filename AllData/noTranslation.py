...
train_dataloader, val_dataloader = get_datasets(get_training_images_and_masks, get_testing_images_and_masks, batch_size = 64, center_crop_size = (224, 224), augmentation = True)
...
model = {"model": UNet2d(in_channels = 1, n_classes = 1, n_channels = 16).to('cuda'), "name":"noTranslation5"}
